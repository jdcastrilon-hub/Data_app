...
// Filtros propios de "Valoracion de Inventario": hoy son los mismos que Inventario,
// pero se dejan en su propio componente porque este reporte va a sumar filtros
// especificos (ej. "costo en $0") que no aplican a Inventario.
@Component({
  selector: 'filtrosvaloracion',
  ...
  templateUrl: './filtrosvaloracion.component.html',
  styleUrl: './filtrosvaloracion.component.scss'
})
export class FiltrosvaloracionComponent {

  @Input() reporteActual: string = 'valoracion';
  ...
  cargarFiltros() {
    ...
    const guardado = this.filtrosState.valoracion;
    if (guardado) {
