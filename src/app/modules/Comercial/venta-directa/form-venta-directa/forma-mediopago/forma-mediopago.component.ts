...
@Component({
  ...
  templateUrl: './forma-mediopago.component.html',
  styleUrl: './forma-mediopago.component.scss'
})
export class FormaMediopagoComponent {
  // Total fijo de la factura para la validación
